...
const Header = () => {
  ...
  const NavLink = ({ title }) => (
    <LinkScroll
      ...
      spy
      smooth
      className="base-bold text-primary-4 uppercase transition-colors duration-500 cursor-pointer hover:text-primary-1 max-lg:my-4 max-lg:h5"
    >
      {title}
    </LinkScroll>
  );
    ...
    >
      <div className="container flex h-14 items-center max-lg:px-5">
        ...
        <button
          ...
          className="lg:hidden z-2 size-10 border-2 border-secondary/25 rounded-full flex justify-center items-center"
        >
          <img
